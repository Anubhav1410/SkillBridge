...
// Model can be overridden via env, e.g. gemini-3.5-flash / gemini-flash-lite-latest
const MODEL = process.env.GEMINI_MODEL || "gemini-flash-lite-latest";

// Disable "thinking" so responses come back in seconds instead of minutes.
// Set GEMINI_THINKING_BUDGET to a positive number to re-enable deeper reasoning.
